---
id: node_b10da94bf0e544d8a3dbfc96efe9d0b3
type: task
...
## Task
Fixed the config button in the Second Brain app so it works correctly for non-logged-in users.

**Status:** Completed on 2026-06-25.

### Details
- The config button was not functioning properly when no user was logged in.
- Investigated the issue and shipped a fix today.